...
//======================================CSV===================================================================
    ...
    $('body').on('click' , '.new_csv_schedule',function () {
        $.ajax({
            url: '',
            type: 'get',
            data:{
                action: "new_csv_schedule",
                csv_schedule_name: $('.csv_schedule_name').val()
            },
            success:function(response){
                $("#field_table").empty();
                ...
                for (list in csv_list) {
                    ...
                    $("#field_table").append('<tr id="'+list_content["id"]+'"><td><div class="form-check"><input class="form-check-input" type="radio" name="inlineRadioOptions" value="'+list_content["id"]+'"><label class="form-check-label" for="inlineRadio1"><a href="/csv_edit/'+list_content["id"]+'">'+list_content["text"]+'</a></label></div></td></tr>');
                }
            }
        });
    });
