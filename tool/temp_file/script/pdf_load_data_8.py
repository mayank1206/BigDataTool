...
os.system("hdfs dfs -get /user/hadoop/pdf_test/* /home/hadoop/project/BigDataTool/tool/temp_file/stagging/")
os.system("hdfs dfs -rm /user/hadoop/pdf_test/*")
...
os.system("hdfs dfs -put /home/hadoop/project/BigDataTool/tool/temp_file/convert/* /user/hive/warehouse/pdf_load_data")
