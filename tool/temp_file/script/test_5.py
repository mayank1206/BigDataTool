...
os.system("hdfs dfs -get /user/hadoop/csv_test/* /home/hadoop/project/BigDataTool/tool/temp_file/stagging/")
os.system("hdfs dfs -rm /user/hadoop/csv_test/*")
...
output_data = input_file[['Username', 'Identifier', 'Last name']]
output_df = pd.DataFrame(output_data)
output_df.to_csv("/home/hadoop/project/BigDataTool/tool/temp_file/convert/"+file_name[0], index=False,header=False)
os.system("hdfs dfs -put /home/hadoop/project/BigDataTool/tool/temp_file/convert/* /user/hive/warehouse/test")
